...
export function getMaxSafeBasal(profile: Profile) {
    ...
    var max_daily_safety_multiplier = profile.max_daily_safety_multiplier || 3;
    var current_basal_safety_multiplier = profile.current_basal_safety_multiplier || 4;

    return Math.min(profile.max_basal || 0, max_daily_safety_multiplier * (profile.max_daily_basal || 0), current_basal_safety_multiplier * (profile.current_basal || 0));
};
